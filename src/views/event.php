...
// Recording user inreactions (Don't touch it).
if($isLoggedIn){
   $interactionController = new InteractionController();
   $interactionController->recordInteraction($_SESSION['user_id'], $eventId, 'view');
}
               ...
               <div class="sidebar-card">
                  ...
                  <?php else: ?>
                     <?php foreach ($trendingEvents as $event): ?>
                        <div class="side-event-card" data-event-id="<?php echo htmlspecialchars('../../event/' . $event['id']); ?>">
